...
export const Project: React.FC<ProjectProps> = ({ data: { project, images } }) => {
  ...
  return (
    <Layout color={project.color}>
      <SEO
        ...
        title={`${project.titleDetail} | Jodie`}
        desc={project.desc}
        node={project.parent}
      ...
      <PBox py={10} px={[6, 6, 8, 10]}>
        ...
        <animated.h1 style={titleAnimation}>{project.titleDetail}</animated.h1>
