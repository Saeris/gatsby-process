...
import { unstable_FormStateReturn as FormState } from "reakit/Form";
import { Label, Input, Span } from "./elements";
import { isActive } from "./isActive";
import { isValid } from "./isValid";

interface ActionProps extends FormState<Record<any, any>> {
...
export const Action: React.FC<ActionProps> = ({
  ...
  return (
    ...
    >
      ...
      <Span disabled={props?.disabled} className={className} style={style} valid={valid} />
      {children}
    </Label>
  );
};
